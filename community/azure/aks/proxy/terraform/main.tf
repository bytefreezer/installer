# COMMUNITY GUIDE - NOT TESTED WITH MCP RUNTIME
# Azure Blob Storage requires an S3-compatible gateway for ByteFreezer services.
# For verified configs, use MCP-generated Docker Compose or Helm deployments.
# See: docs/guide-onprem-docker.md or docs/guide-onprem-k8s.md
