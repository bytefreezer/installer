...
> **Community Guide**: This deployment target has not been end-to-end tested with the MCP runtime.
> Config templates have been aligned with verified config keys but the full pipeline has not been validated on this platform.
> For verified deployments, use the [MCP-guided Docker Compose](../docs/guide-onprem-docker.md)
> or [Kubernetes/Helm](../docs/guide-onprem-k8s.md) guides.
