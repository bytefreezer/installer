...
- [Method A: Step-by-Step Manual](#method-a-step-by-step-manual)
  - [Phase 1: Create Account and Configure](#phase-1-create-account-and-configure)
  - [Phase 2: Deploy Proxy on Testhost](#phase-2-deploy-proxy-on-testhost)
  - [Phase 3: Verify the Pipeline](#phase-3-verify-the-pipeline)
  - [Phase 4: Explore Features](#phase-4-explore-features)
